...
ruled.notification.connect_signal("request::rules", function()
    ...
    ruled.notification.append_rule {
        ...
        properties = { bg = "#000000", fg = "#ff0000", timeout = 0 }
    }

    -- Or green background for normal ones.
    ruled.notification.append_rule {
        rule       = { urgency = "normal" },
        properties = { bg      = "#000000", fg = "#00ff00"}
    }
end)
...
-- awful.spawn.with_shell("$HOME/.config/scripts/autostart")
-- awful.spawn.with_shell("$HOME/.config/awesome/dunst_starter.sh")
-- awful.spawn.with_shell("bash ~/.config/scripts/mount.sh")
awful.spawn.with_shell("picom --experimental-backends")
awful.spawn.with_shell("dunst")
awful.spawn.with_shell("feh --bg-fill -r -z ~/Media/Wallpapers")
awful.spawn.with_shell("xfce4-power-manager")
awful.spawn.with_shell("xsettingsd")
awful.spawn.with_shell("caffeine")
awful.spawn.with_shell("nm-applet")
awful.spawn.with_shell("bash ~/.config/scripts/battery-status.sh &")
awful.spawn.with_shell("bash ~/.config/polybar/launch.sh &")
awful.spawn.with_shell("bash ~/.config/scripts/lock_scripts.sh")
awful.spawn.with_shell("udiskie -a")
awful.spawn.with_shell("redshift -l 9.900239:76.744881")
